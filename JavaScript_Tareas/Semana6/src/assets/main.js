...
// URL API 
const API = 'https://youtube-v31.p.rapidapi.com/search?channelId=UCZiyPvz2BTIqkl0j0A_Ae9Q&part=snippet%2Cid&order=date&maxResults=10';
const options = {
	method: 'GET',
	headers: {
